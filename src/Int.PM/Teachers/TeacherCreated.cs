...
{
    [Serializable]
    public class TeacherCreated : DomainEvent<string>
    {
        ...
        public TeacherCreated(string id, string name, string sex, string source,   string seniority, string officePhone, 
