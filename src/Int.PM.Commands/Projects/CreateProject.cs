...
{
    [Serializable]
    public class StartTrainingProject : AggregateCommand<string>
    {
        ...
        public StartTrainingProject(string id, string trainingTarget, string numOfPerson, string receivedTime, string days, string expectTime, string courseTitle,
    ...
    [Serializable]
    public class StartConsultProject : AggregateCommand<string>
    {
        ...
        public string CourseOther { get; private set; }
        public StartConsultProject(string id,string rname, string area, string rTelephone, string rEmail, string cusBank, string cusMainBranch, string cusSubBranch,
