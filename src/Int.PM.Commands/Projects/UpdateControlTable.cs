...
{
    [Serializable]
    public class UpdateControlTable: AggregateCommand<string>
    {
        ...
        public UpdateControlTable(string id, string order, string time, string type, string name, string content, string remark)
            : base(id)
        {
            Order = order;
            Time = time;
