...
{
    [Serializable]
    public class ChangeDetailTeacher : AggregateCommand<string>
    {
        /// <summary>
        /// 年龄段
        /// </summary>
        ...
        public ChangeDetailTeacher(string id, string age, string isInOffice, DateTime? leaveOfficeTime, int workingTimePlan, string province,
            ...
            string eduExperience, int price, string remark, string[] territories, string[] industries, string[] products)
            : base(id) 
        {
            Age = age;
