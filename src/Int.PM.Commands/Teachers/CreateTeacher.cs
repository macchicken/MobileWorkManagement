...
{
    [Serializable]
    public class CreateTeacher : AggregateCommand<string>, ICreatingAggregateCommand
    {
        ...
        public CreateTeacher(string name, string sex, string source, string seniority, string officePhone,
