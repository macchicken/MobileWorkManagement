namespace Int.Repository.Specification
{
    using System;
    using System.Linq;
        ...
        where TEntity : class
    {
        ...
        /// <summary>
        /// <see cref="Int.Repository.Specification.ISpecification{TEntity}"/>
        /// </summary>
        /// <returns><see cref="Int.Repository.Specification.ISpecification{TEntity}"/></returns>
