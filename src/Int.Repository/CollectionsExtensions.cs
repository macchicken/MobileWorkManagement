...
namespace Int.Repository
{
    ...
    public static class CollectionsExtensions
    {
        ...
        {
            return QueryableHelper<T>.SortBy(source, propertyName, sortDirection);
        }
        ...
        /// <returns></returns>
        public static IOrderedQueryable<T> SortBy<T>(this IQueryable<T> source, PropertySortCondition sortCondition)
        {
            return source.SortBy(sortCondition.PropertyName, sortCondition.ListSortDirection);
        }
            ...
            out int total, PropertySortCondition[] sortConditions = null)
        {
            ...
            if (sortConditions != null && sortConditions.Length > 0)
            {
                ...
                {
                    orderSource = count == 0
                        ? source.SortBy(sortCondition.PropertyName, sortCondition.ListSortDirection)
        ...
        private static class QueryableHelper<T>
        {
            ...
            internal static IOrderedQueryable<T> SortBy(IQueryable<T> source, string propertyName, ListSortDirection sortDirection)
            {
