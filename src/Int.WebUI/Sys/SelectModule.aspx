<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectModule.aspx.cs" Inherits="Int.WebUI.Sys.SelectModule" %>
        ...
        <Toolbars>
            <f:Toolbar ID="tsbMain" runat="server">
                <Items>
                    ...
                    <f:Button ID="btnExpandAll" Icon="Folder" Text="展开" OnClick="btnExpandAll_Click" runat="server" />
                    <f:Button ID="btnCollapseAll" Icon="FolderUp" Text="收起" OnClick="btnCollapseAll_Click" runat="server" />
                </Items>
            </f:Toolbar>
        </Toolbars>
        <Items>
            <f:Tree runat="server" ID="tvwModule" AutoScroll="true" EnableIcons="false" Expanded="true"
