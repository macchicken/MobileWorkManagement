<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewModule.aspx.cs" Inherits="Int.WebUI.Sys.NewModule" %>
...
<body>
    <form id="frmNewModule" runat="server">
    ...
    <f:Window ID="wdnSelectModule" Title="选择父级模块" EnableMaximize="true" IsModal="true" Height="435px" EnableIFrame="true"
