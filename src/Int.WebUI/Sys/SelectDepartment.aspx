<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectDepartment.aspx.cs" Inherits="Int.WebUI.Sys.SelectDepartment" %>
...
<body>
    ...
    <f:Panel ID="pnlMain" runat="server" ShowBorder="false" Layout="Fit" BoxConfigAlign="Stretch"
        ...
        <Items>
            <f:Tree runat="server" ID="tvwDepartment" AutoScroll="true" EnableIcons="false" Expanded="true"
                Title="部门" ShowHeader="false" ShowBorder="false">
            </f:Tree>
        </Items>
    </f:Panel>
    </form>
