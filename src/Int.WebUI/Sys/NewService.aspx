<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewService.aspx.cs" Inherits="Int.WebUI.Sys.NewService" %>
...
<body>
    ...
    <f:Panel ID="pnlMain" runat="server" Layout="Fit" ShowBorder="False" ShowHeader="false" BodyPadding="5px">
        <Toolbars>
        ...
        <Items>
            <f:Panel ID="pnlForm" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false">
                <Items>
                    <f:SimpleForm ID="frmService" ShowBorder="false" ShowHeader="false" AutoScroll="true" BodyPadding="5px" 
                        runat="server" EnableCollapse="True">
                        <Items>
                            <f:TextBox ID="txtId" Label="服务编号" Required="true" runat="server" />
                            ...
                            <f:TextBox ID="txtFilePath" Label="文件路径" Required="true" runat="server" />
                        </Items>
                    </f:SimpleForm>
                </Items>
            </f:Panel>
