<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewMenu.aspx.cs" Inherits="Int.WebUI.Sys.NewMenu" %>
...
<body>
    <form id="frmNewMenu" runat="server">
                ...
                <Items>
                    <f:SimpleForm ID="frmMenu" ShowBorder="false" ShowHeader="false"
                        ...
                        <Items>
                            ...
                            <f:HiddenField ID="hiddenParentID" Text="0" runat="server" />
    ...
    <f:Window ID="wdnSelectMenu" Title="选择菜单" EnableMaximize="true" IsModal="true" Target="Parent" EnableResize="true" 
        runat="server" Icon="Find" Width="310px" Height="470px" EnableIFrame="true" Hidden="true">
    </f:Window>
    </form>
</body>
</html>
